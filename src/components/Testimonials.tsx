...
const testimonials = [
  ...
  { quote: "Hosted 40+ guests this year from 12 countries. My favorite side hustle by far.", name: "Carlos R.", role: "Host", location: "Mexico City" },
  { quote: "Needed a desk for two days in Paris. Found one in 10 minutes. Booked, done.", name: "Jin H.", role: "Remote Worker", location: "Seoul" },
];
...
export default function Testimonials() {
  return (
    <section id="community" className="relative py-28 lg:py-36">
      ...
      {/* Contained marquee within max-w-7xl */}
      <div className="mx-auto max-w-7xl px-6 lg:px-10">

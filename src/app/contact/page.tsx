      ...
      <section className="px-6 pt-16 pb-10 lg:px-10">
        <div className="mx-auto max-w-6xl text-center">
          ...
          <p className="mx-auto mt-4 max-w-lg text-base text-white/50">
            Whether you have a question, need support, or want to partner — reach us through our{" "}
            <Link href="/support" className="text-[#FF642B] hover:underline">Support page</Link>.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
            {channels.map((ch) => (
              ...
              >
                ...
                <p className="mt-3 inline-flex items-center gap-1 text-xs font-semibold text-[#FF642B]">
                  Contact via Support <span aria-hidden="true">&rarr;</span>
                </p>
              </Link>
            ))}
          </div>
